<template>
  ...
  >
    ...
    <div 
      ...
      v-if="!readonly"
    >
      <a-icon @click.native="handleAdd" type="plus" v-if="ui=='antd'" :style="{fontSize:miniWidth/4+'px',marginTop: (-miniWidth/8)+'px', marginLeft: (-miniWidth/8)+'px', position: 'absolute', left: '50%', top: '50%'}" />
      <i @click.self="handleAdd" v-if="ui == 'element'" class="el-icon-plus" :style="{fontSize:miniWidth/4+'px',marginTop: (-miniWidth/8)+'px', marginLeft: (-miniWidth/8)+'px'}"></i>
